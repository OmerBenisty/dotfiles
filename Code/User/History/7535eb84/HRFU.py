...
today = (datetime.now() - timedelta(days=4)).strftime("%d/%m/%Y %H:%M:%S")
week_ago = datetime.now() - timedelta(days=7 + 4)
...
print("Done!. Report generated: " + "mcdonalds_anomaly_" + week_ago + "-" + today + ".xlsx")
